...
const Contact = () => {
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:gap-10 lg:items-start mt-10">
        ...
        <form
          action="https://getform.io/f/bgddggza"
        ...
        >
          ...
          <button
            className="btn btn-secondary [&]:max-w-full w-full justify-center reveal-up"
            type="submit"
          >
            Submit
          </button>
